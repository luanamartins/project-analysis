...
module.exports = testCase({
    ...
    "TC12": function (test) {
        ...
        test.equal(metricsObject.tryCatchNumberOfReturnsOnCatches, 1);
        test.equal(metricsObject.tryCatchNumberOfReturnsAnErrorOnCatches, 0);
        test.equal(metricsObject.tryCatchNumberOfBreaksOnCatches, 1);
    ...
    "TC13": function (test) {
        ...
        test.equal(metricsObject.tryCatchNumberOfReturnsAnErrorOnCatches, 0);
        test.equal(metricsObject.tryCatchNumberOfBreaksOnCatches, 1);
        test.equal(metricsObject.tryCatchNumberOfBreaksOnCatchesUniqueStatement, 1);
