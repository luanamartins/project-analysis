...
const projectPath = '/home/lulis/Documents/UFPE/Mestrado/Projeto/static-analysis/project-analysis/transfer/retrieve-scripts';
console.log(projectPath);

const inputGithubFilepath = path.join(projectPath, 'github.txt');
const outputGithubFilepath = path.join(projectPath, 'repos');
const dataFilepath = path.join(projectPath, 'statistics/data/');
...
function extractMetricsFromFiles(repositoryName, files, callback) {
    ...
    filesModule.writeCsvFile(dataFilepath + repositoryName + '.csv', headers, metrics);
